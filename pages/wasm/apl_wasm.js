...
export class Board {
    ...
    paste(text) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.board_paste(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
    ...
    press(key, ctrl, alt) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.board_press(this.__wbg_ptr, ptr0, len0, ctrl, alt);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    take() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.board_take(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_load_91a6aa0daed53d0b: function() { return handleError(function (arg0, arg1) {
        ...
        __wbg_new_with_byte_offset_and_length_edceafd3cbaf9910: function(arg0, arg1, arg2) {
        ...
        __wbg_store_7b84f2139ed609ba: function() { return handleError(function (arg0, arg1, arg2) {
        ...
        __wbg_wait_d3dfecdb3aeb4684: function() { return handleError(function (arg0, arg1, arg2) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('apl_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
