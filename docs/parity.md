...
| (B) '75: `⎕CT` set to another tolerance, a system variable localized in a function header, `⎕PW` 128 while a definition is open, indexed assignment into a system variable | -- | not implemented | NONCE ERROR, or not implemented |
