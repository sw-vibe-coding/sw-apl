...
| (B) '75: a function fixed under a name that is running, waiting, locked, a variable or local to a running function is refused, the header being the line at fault; local function names are not implemented | -- | part | system functions session tests |
