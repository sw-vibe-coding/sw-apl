...
reads the profile: execute and format are '72 glyphs, and in '68 they
...
Then execute, in a new '72-only crate: monadic, a character vector
evaluated as a line in the current workspace, per docs/aplsv.md. Its
errors are the line's errors. Sample for '72 (the sample harness
